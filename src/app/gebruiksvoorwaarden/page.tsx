    ...
    <div className="min-h-screen bg-[#F4F1E8] px-4 py-10">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-3xl border border-black/8 p-8 space-y-8">
          <div>
            <h1 style={{ ...SYNE, fontWeight: 900, fontSize: 28, color: '#1E2B20' }}>Gebruiksvoorwaarden</h1>
            <p className="text-sm text-gray-400 mt-1">Laatst bijgewerkt: april 2026</p>
          </div>

          <section className="space-y-3">
            <h2 style={{ ...SYNE, fontWeight: 800, fontSize: 16, color: '#1E2B20' }}>Gebruik van de app</h2>
          ...
          <section className="space-y-3">
            <h2 style={{ ...SYNE, fontWeight: 800, fontSize: 16, color: '#1E2B20' }}>Account</h2>
            <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 style={{ ...SYNE, fontWeight: 800, fontSize: 16, color: '#1E2B20' }}>Inhoud</h2>
            <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 style={{ ...SYNE, fontWeight: 800, fontSize: 16, color: '#1E2B20' }}>Aansprakelijkheid</h2>
            <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 style={{ ...SYNE, fontWeight: 800, fontSize: 16, color: '#1E2B20' }}>Contact</h2>
            <p className="text-sm text-gray-600 leading-relaxed">
              Vragen over deze voorwaarden?{' '}
              <a href="mailto:hallo@buddys.nl" className="text-[#C4F542] font-semibold hover:underline">hallo@buddys.nl</a>
            </p>
          </section>
        </div>
      </div>
