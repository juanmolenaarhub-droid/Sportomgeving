...
export function ProfileHeader({
  ...
  return (
    <div>
      {/* Banner */}
      <div className={`relative ${bannerH} rounded-t-2xl overflow-hidden bg-gradient-to-r from-[#1E2B20] to-gray-700`}>
        {bannerPreview && (
          ...
          {editable && (
            <>
              <button
                ...
                className="absolute bottom-1 right-1 w-7 h-7 bg-[#1E2B20] rounded-full flex items-center justify-center shadow-md hover:bg-[#333] transition-colors"
              >
