...
export const SPORTS: Sport[] = [
  ...
  { id: 'trailrunning',      label: 'Trailrunning',            emoji: '',  category: 'hardlopen_fietsen',   popular: false },
  ...
  { id: 'atletiek',          label: 'Atletiek',                emoji: '',  category: 'hardlopen_fietsen',   popular: false },
  ...
  { id: 'orientatielopen',   label: 'Oriëntatielopen',         emoji: '',  category: 'hardlopen_fietsen',   popular: false },
  ...
  { id: 'crossfit',          label: 'CrossFit',                emoji: '',  category: 'fitness_gym',         popular: false },
  { id: 'powerlifting',      label: 'Powerlifting',            emoji: '',  category: 'fitness_gym',         popular: false },
  { id: 'weightlifting',     label: 'Gewichtheffen',           emoji: '',  category: 'fitness_gym',         popular: false },
  ...
  { id: 'skeeleren',         label: 'Skeeleren / Inline Skating',emoji: '',category: 'outdoor_natuur',      popular: false },
  { id: 'rolschaatsen',      label: 'Rolschaatsen',            emoji: '',  category: 'outdoor_natuur',      popular: false },
  ...
  // ── WINTERSPORT ──────────────────────────────────────────────────────────
  { id: 'skiën',             label: 'Skiën (piste)',           emoji: '',  category: 'wintersport',         popular: true  },
  { id: 'langlaufen',        label: 'Langlaufen',              emoji: '',  category: 'wintersport',         popular: false },
  { id: 'freestyle_skien',   label: 'Freestyle Skiën',         emoji: '',  category: 'wintersport',         popular: false },
  { id: 'snowboarden',       label: 'Snowboarden',             emoji: '',  category: 'wintersport',         popular: false },
  { id: 'schaatsen',         label: 'Schaatsen',               emoji: '',  category: 'wintersport',         popular: true  },
  { id: 'curling',           label: 'Curling',                 emoji: '',  category: 'wintersport',         popular: false },
  { id: 'biathlon',          label: 'Biathlon',                emoji: '',  category: 'wintersport',         popular: false },
  { id: 'skispringen',       label: 'Skispringen',             emoji: '',  category: 'wintersport',         popular: false },
  ...
  { id: 'zweefvliegen',      label: 'Zweefvliegen',            emoji: '',  category: 'avontuur_lucht',      popular: false },
  { id: 'hanggliden',        label: 'Hanggliden',              emoji: '',  category: 'avontuur_lucht',      popular: false },
  { id: 'motorsport',        label: 'Motorsport / Karting',    emoji: '',  category: 'avontuur_lucht',      popular: false },
  { id: 'motorcross',        label: 'Motorcross',              emoji: '',  category: 'avontuur_lucht',      popular: false },
  { id: 'mountaineering',    label: 'Alpinisme / Bergbeklimmen',emoji: '', category: 'avontuur_lucht',      popular: false },
